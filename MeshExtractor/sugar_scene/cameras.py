...
def load_gs_cameras_train(source_path, gs_output_path, image_resolution=1,
                    load_gt_images=True, max_img_size=1920, white_background=False,
                    remove_indices=[]):
    """Loads Gaussian Splatting camera parameters from a COLMAP reconstruction.
    ...
    with open(gs_output_path + 'train_cameras.json') as f:
        unsorted_camera_transforms = json.load(f)
...
def load_gs_cameras_test(source_path, gs_output_path, image_resolution=1,
                    load_gt_images=True, max_img_size=1920, white_background=False,
                    remove_indices=[]):
    """Loads Gaussian Splatting camera parameters from a COLMAP reconstruction.
    ...
    with open(gs_output_path + 'test_cameras.json') as f:
        unsorted_camera_transforms = json.load(f)
