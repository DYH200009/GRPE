...
from .cameras import CamerasWrapper, load_gs_cameras , load_gs_cameras_train ,load_gs_cameras_test
...
class GaussianSplattingWrapper:
    ...
    def __init__(self, 
        ...
        train_cam_list = load_gs_cameras_train(
            source_path=source_path,
            gs_output_path=output_path,
            load_gt_images=load_gt_images,
            white_background=white_background,
        ...
        test_cam_list = load_gs_cameras_test(
            source_path=source_path,
            gs_output_path=output_path,
            load_gt_images=load_gt_images,
            white_background=white_background,
        ...
        ###
        if eval_split:
            self.cam_list = train_cam_list
            self.test_cam_list = test_cam_list
            # for i, cam in enumerate(cam_list):
            #     if i % eval_split_interval == 0:
            #         self.test_cam_list.append(cam) ### 测试的视角
            #     else:
            #         self.cam_list.append(cam) ### 训练的视角
        ...
        print("The length of  self.training_cameras",len(self.training_cameras))
